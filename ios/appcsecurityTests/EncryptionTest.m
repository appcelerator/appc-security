...
- (void)testDecryption128 {
	...
	NSString *result = decrypt(value,key,pepper,hmacKey,encoding,128);
...
- (void)testDecryption128WithDerivedKey {
	...
	NSString *hmacKey = @"hmacKey";
	NSString *encoding = @"base64";
	NSString *result = decryptWithKey(value,key,pepper,hmacKey,encoding,128);
	NSString *expected = @"ABC";
	XCTAssertEqualObjects(result,expected);
}
...
- (void)testDecryption192 {
	...
	NSString *hmacKey = @"hmacKey";
	NSString *encoding = @"base64";
	NSString *result = decrypt(value,key,pepper,hmacKey,encoding,192);
	NSString *expected = @"ABC";
	XCTAssertEqualObjects(result,expected);
}
...
- (void)testDecryption192WithDerivedKey {
	...
	NSString *hmacKey = @"hmacKey";
	NSString *encoding = @"base64";
	NSString *result = decryptWithKey(value,key,pepper,hmacKey,encoding,192);
	NSString *expected = @"ABC";
	XCTAssertEqualObjects(result,expected);
}
...
- (void)testDecryption256 {
	...
	NSString *hmacKey = @"hmacKey";
	NSString *encoding = @"base64";
	NSString *result = decrypt(value,key,pepper,hmacKey,encoding,256);
	NSString *expected = @"ABC";
	XCTAssertEqualObjects(result,expected);
}
...
- (void)testDecryption256WithDerivedKey {
	...
	NSString *hmacKey = @"hmacKey";
	NSString *encoding = @"base64";
	NSString *result = decryptWithKey(value,key,pepper,hmacKey,encoding,256);
	NSString *expected = @"ABC";
	XCTAssertEqualObjects(result,expected);
}
...
- (void)testPerformanceDecryption256WithDerivedKeyAndHighRotations {
	[self measureBlock:^{
		for (size_t c=0;c<100;c++){
			[self testDecryption256WithDerivedKeyAndHighRotations];
		}
	}];
}
